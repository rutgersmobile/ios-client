...
@implementation ColoredTileCollectionViewItem
...
-(void)setupCell:(ColoredTileCollectionViewCell *)cell{
...
-(void)setCellBackgroundColor:(ColoredTileCollectionViewCell *)cell{
