...
-(void)makeConstraints{
    ...
    [self.detailLabel autoPinEdgeToSuperviewEdge:ALEdgeLeft withInset:kLabelHorizontalInsets];
    [self.detailLabel autoPinEdgeToSuperviewEdge:ALEdgeRight withInset:0];
